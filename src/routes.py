...
from src.resources.populate_db import PopulateDB, PopulateDBThreads, PopulateDBProcesses, PopulateDBSequentially
...
api.add_resource(PopulateDBSequentially, '/populate/sequentially', strict_slashes=False)
