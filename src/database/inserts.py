...
def populate_movies():
    ...
    harry_potter_and_priz_az = Movie(
    ...
    harry_potter_and_ph_goblet_fire = Movie(
    ...
    harry_potter_and_order_phoenix = Movie(
        title='Harry Potter and the Order of the Phoenix',
        release_date=date(2007, 7, 19),
        description='With their warning about Lord Voldemort\'s (Ralph Fiennes\') return scoffed at, Harry '
                    '(Daniel Radcliffe) and Dumbledore (Sir Michael Gambon) are targeted by the Wizard authorities '
                    'as an authoritarian bureaucrat slowly seizes power at Hogwarts.',
        distributed_by='Warner Bros. Pictures',
        length=138,
        rating=7.5,
    )
    harry_potter_and_half_blood_prince = Movie(
    ...
    harry_potter_and_deathly_hallows_1 = Movie(
        title='Harry Potter and the Deathly Hallows part 1',
        release_date=date(2010, 11, 18),
        description='As Harry (Daniel Radcliffe), Ron (Rupert Grint), and Hermione (Emma Watson) race against time and '
                    'evil to destroy the Horcruxes, they uncover the existence of the three most powerful objects in '
                    'the wizarding world: the Deathly Hallows.',
        distributed_by='Warner Bros. Pictures',
        length=146,
        rating=7.7,
    )
    harry_potter_and_deathly_hallows_2 = Movie(
